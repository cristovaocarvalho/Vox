...
const ptBR: TranslationKeys = {
  ...
  commands: {
    ...
    defaultNotice: 'O Vox inclui {n} comandos integrados. Você pode desativar qualquer um deles ou adicionar seus próprios comandos abaixo.',
  ...
  modelsTab: {
    speech: 'Voz',
    language: 'Linguagem',
    defaultSpeech: 'Modelo de Voz Padrão',
    defaultLanguage: 'Modelo de Linguagem Padrão',
    ...
    noModelsSynced: 'Nenhum modelo sincronizado. Conecte a um provedor para visualizar os modelos disponíveis.',
